...
#years = []; # make an empty array to hold years
...
for i in [0]:#range(len(startDay)):
    ...
    for j in [0]:#range(len(indexList)):
        ...
        '''if fileNamePrefix == 'epa_code-r0801-TCG-7-19842016-04150715':
            import pdb; pdb.set_trace()'''
        task.start()
...
''' make dataframe of tasks >> write to text file'''
